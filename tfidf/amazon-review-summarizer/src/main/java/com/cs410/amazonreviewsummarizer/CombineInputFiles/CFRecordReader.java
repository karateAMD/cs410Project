 ...
 */
public class CFRecordReader extends RecordReader<CFFileLineWritable, Text>{
    ...
    @Override
    public CFFileLineWritable getCurrentKey() throws IOException, InterruptedException {
        return key;
    }
